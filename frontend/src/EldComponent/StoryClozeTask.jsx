...
import StoryQuestion from "../Assets/ELD/StoryQuestion.mp3";
...
const StoryClozeTask = () => {
  ...
  if (!stories.length)
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-100 to-indigo-200">
        <p className="text-lg font-semibold text-red-500">කථා නොමැත.</p>
      </div>
    );
  ...
  const playAudio = () => {
    const audio = new Audio(StoryQuestion); 
    audio.play();
  };
      ...
      <div className="font-sans min-h-screen bg-gradient-to-b from-blue-100 to-indigo-200 flex flex-col items-center justify-center py-10 px-4">
        ...
        <div className="w-full max-w-6xl border-4 border-indigo-300 rounded-3xl shadow-2xl bg-white p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2 flex items-center gap-2 ml-40 text-xl">
              <FaVolumeUp
                className="cursor-pointer text-indigo-600 text-center hover:text-indigo-800"
                onClick={playAudio}
                title="Play Audio"
              />
              <span>
                කතාවට සවන් දෙන්න. නිවැරදි පිළිතුර ඇදගෙන ගොස් සියලු හිස්තැන්
                පුරවන්න.
              </span>
            </p>
          ...
          <div className="rounded-2xl p-6 flex flex-col lg:flex-row gap-10">
            ...
            <div className="flex-1">
                  ...
                  <span key={i}>
                    ...
                    {i < textParts.length - 1 && (
                      <span
                        ...
                        ${
                          showResults
                            ? filledBlanks[i] === currentStory.blanks_answers[i]
              ...
              {/* Options */}
              <div className="mt-6">
                <p className="font-medium text-gray-700 mb-3">පිළිතුරු:</p>
