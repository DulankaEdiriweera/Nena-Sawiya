...
const LEVEL_CONFIG = {
  easy:   {label: "පහසු",   color: "bg-green-400",  border: "border-green-300",  text: "text-green-700"},
  medium: {label: "මධ්‍යම", color: "bg-yellow-400", border: "border-yellow-300", text: "text-yellow-700" },
  hard:   {label: "දුෂ්කර",   color: "bg-rose-400",   border: "border-rose-300",   text: "text-rose-700" },
};
      ...
      <div className="flex justify-center gap-3 mb-8">
        {Object.entries(LEVEL_CONFIG).map(([key, c]) => (
          ...
          >
            ...
            {c.label}
            <span className="text-xs mt-0.5 opacity-75">{c.grid}</span>
          </button>
        ))}
      </div>
